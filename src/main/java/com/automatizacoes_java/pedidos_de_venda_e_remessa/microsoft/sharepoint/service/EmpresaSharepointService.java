...
@Service
public class EmpresaSharepointService
		extends AbstractSharePointService<EmpresaSharepointDTO, EmpresaSharepointListResponse> {
	...
	@Override
	protected Class<EmpresaSharepointDTO> getDtoClass() {
