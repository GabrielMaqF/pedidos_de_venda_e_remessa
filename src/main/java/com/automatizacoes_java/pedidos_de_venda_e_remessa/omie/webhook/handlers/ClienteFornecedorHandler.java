...
@Component
public class ClienteFornecedorHandler implements OmieWebhookHandler {
	private static final Logger logger = LoggerFactory.getLogger(ClienteFornecedorHandler.class);

	private final ObjectMapper objectMapper = new ObjectMapper();

	private final Map<String, OmieWebhookActionStrategy<ClienteFornecedorDTO>> actionStrategies;

	public ClienteFornecedorHandler(List<OmieWebhookActionStrategy<ClienteFornecedorDTO>> strategies) {
